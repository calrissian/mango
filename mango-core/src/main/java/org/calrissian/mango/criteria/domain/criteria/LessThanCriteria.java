...
public class LessThanCriteria extends AbstractLexiTypedKeyValueLeafCriteria {
  public LessThanCriteria(String key, Object value, TypeRegistry<String> lexiTypes, ParentCriteria parentCriteria) {
