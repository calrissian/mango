...
public class LessThanEqualsCriteria extends AbstractLexiTypedKeyValueLeafCriteria {
  public LessThanEqualsCriteria(String key, Object value, TypeRegistry<String> lexiTypes, ParentCriteria parentCriteria) {
