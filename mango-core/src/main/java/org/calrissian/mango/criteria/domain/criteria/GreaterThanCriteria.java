...
public class GreaterThanCriteria extends AbstractLexiTypedKeyValueLeafCriteria {
  public GreaterThanCriteria(String key, Object value, TypeRegistry<String> lexiTypes, ParentCriteria parentCriteria) {
