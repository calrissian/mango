...
import static mango.jms.decorator.JmsTopicDecoratorConstants.preSendMessage;
...
public class JmsMessageProducerTopicDecorator implements MessageProducer {
    ...
    public void send(Message message) throws JMSException {
        preSendMessage(message, topic, selectorDestination);
    ...
    public void send(Destination destination, Message message) throws JMSException {
        ...
        preSendMessage(message, topic, destination);
        producer.send(message);
    }
